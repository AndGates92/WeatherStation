...
#define ETM_NONSECUREINSTRTRACINGSUPPORTED_EXCEPTIONLEVEL3_OFFSET  (REGISTER_FIELD_OFFSET(ETM, IDR3, EXLEVEL_NS) + ETM_EXCEPTIONLEVEL3)
#define ETM_NONSECUREINSTRTRACINGSUPPORTED_EXCEPTIONLEVEL3_MASK    (0x1UL << REGISTER_FIELD_OFFSET(ETM, NONSECUREINSTRTRACINGSUPPORTED, EXCEPTIONLEVEL3))  /*!< Mask  0x00800000 */

#define ETM_NONSECUREINSTRTRACINGSUPPORTED_EXCEPTIONLEVEL2_OFFSET  (REGISTER_FIELD_OFFSET(ETM, IDR3, EXLEVEL_NS) + ETM_EXCEPTIONLEVEL2)
#define ETM_NONSECUREINSTRTRACINGSUPPORTED_EXCEPTIONLEVEL2_MASK    (0x1UL << REGISTER_FIELD_OFFSET(ETM, NONSECUREINSTRTRACINGSUPPORTED, EXCEPTIONLEVEL2))  /*!< Mask  0x00400000 */

#define ETM_NONSECUREINSTRTRACINGSUPPORTED_EXCEPTIONLEVEL1_OFFSET  (REGISTER_FIELD_OFFSET(ETM, IDR3, EXLEVEL_NS) + ETM_EXCEPTIONLEVEL1)
#define ETM_NONSECUREINSTRTRACINGSUPPORTED_EXCEPTIONLEVEL1_MASK    (0x1UL << REGISTER_FIELD_OFFSET(ETM, NONSECUREINSTRTRACINGSUPPORTED, EXCEPTIONLEVEL1))  /*!< Mask  0x00200000 */

#define ETM_NONSECUREINSTRTRACINGSUPPORTED_EXCEPTIONLEVEL0_OFFSET  (REGISTER_FIELD_OFFSET(ETM, IDR3, EXLEVEL_NS) + ETM_EXCEPTIONLEVEL0)
#define ETM_NONSECUREINSTRTRACINGSUPPORTED_EXCEPTIONLEVEL0_MASK    (0x1UL << REGISTER_FIELD_OFFSET(ETM, NONSECUREINSTRTRACINGSUPPORTED, EXCEPTIONLEVEL0))  /*!< Mask  0x00100000 */
...
#define ETM_SECUREINSTRTRACINGSUPPORTED_EXCEPTIONLEVEL3_OFFSET  (REGISTER_FIELD_OFFSET(ETM, IDR3, EXLEVEL_S) + ETM_EXCEPTIONLEVEL3)
#define ETM_SECUREINSTRTRACINGSUPPORTED_EXCEPTIONLEVEL3_MASK    (0x1UL << REGISTER_FIELD_OFFSET(ETM, SECUREINSTRTRACINGSUPPORTED, EXCEPTIONLEVEL3))  /*!< Mask  0x00080000 */

#define ETM_SECUREINSTRTRACINGSUPPORTED_EXCEPTIONLEVEL2_OFFSET  (REGISTER_FIELD_OFFSET(ETM, IDR3, EXLEVEL_S) + ETM_EXCEPTIONLEVEL2)
#define ETM_SECUREINSTRTRACINGSUPPORTED_EXCEPTIONLEVEL2_MASK    (0x1UL << REGISTER_FIELD_OFFSET(ETM, SECUREINSTRTRACINGSUPPORTED, EXCEPTIONLEVEL2))  /*!< Mask  0x00040000 */

#define ETM_SECUREINSTRTRACINGSUPPORTED_EXCEPTIONLEVEL1_OFFSET  (REGISTER_FIELD_OFFSET(ETM, IDR3, EXLEVEL_S) + ETM_EXCEPTIONLEVEL1)
#define ETM_SECUREINSTRTRACINGSUPPORTED_EXCEPTIONLEVEL1_MASK    (0x1UL << REGISTER_FIELD_OFFSET(ETM, SECUREINSTRTRACINGSUPPORTED, EXCEPTIONLEVEL1))  /*!< Mask  0x00020000 */

#define ETM_SECUREINSTRTRACINGSUPPORTED_EXCEPTIONLEVEL0_OFFSET  (REGISTER_FIELD_OFFSET(ETM, IDR3, EXLEVEL_S) + ETM_EXCEPTIONLEVEL0)
#define ETM_SECUREINSTRTRACINGSUPPORTED_EXCEPTIONLEVEL0_MASK    (0x1UL << REGISTER_FIELD_OFFSET(ETM, SECUREINSTRTRACINGSUPPORTED, EXCEPTIONLEVEL0))  /*!< Mask  0x00010000 */
...
// Values of bits of register controlling whether instruction tracing is supported for a given exception level in non secure state
#define ETM_NONSECUREINSTRTRACINGSUPPORTED_EXCEPTIONLEVEL3_OFFSET  (REGISTER_FIELD_OFFSET(ETM, ACATR, EXLEVEL_NS) + ETM_EXCEPTIONLEVEL3)
#define ETM_NONSECUREINSTRTRACINGSUPPORTED_EXCEPTIONLEVEL3_MASK    (0x1UL << REGISTER_FIELD_OFFSET(ETM, NONSECUREINSTRTRACINGSUPPORTED, EXCEPTIONLEVEL3))  /*!< Mask  0x00800000 */

#define ETM_NONSECUREINSTRTRACINGSUPPORTED_EXCEPTIONLEVEL2_OFFSET  (REGISTER_FIELD_OFFSET(ETM, ACATR, EXLEVEL_NS) + ETM_EXCEPTIONLEVEL2)
#define ETM_NONSECUREINSTRTRACINGSUPPORTED_EXCEPTIONLEVEL2_MASK    (0x1UL << REGISTER_FIELD_OFFSET(ETM, NONSECUREINSTRTRACINGSUPPORTED, EXCEPTIONLEVEL2))  /*!< Mask  0x00400000 */

#define ETM_NONSECUREINSTRTRACINGSUPPORTED_EXCEPTIONLEVEL1_OFFSET  (REGISTER_FIELD_OFFSET(ETM, ACATR, EXLEVEL_NS) + ETM_EXCEPTIONLEVEL1)
#define ETM_NONSECUREINSTRTRACINGSUPPORTED_EXCEPTIONLEVEL1_MASK    (0x1UL << REGISTER_FIELD_OFFSET(ETM, NONSECUREINSTRTRACINGSUPPORTED, EXCEPTIONLEVEL1))  /*!< Mask  0x00200000 */

#define ETM_NONSECUREINSTRTRACINGSUPPORTED_EXCEPTIONLEVEL0_OFFSET  (REGISTER_FIELD_OFFSET(ETM, ACATR, EXLEVEL_NS) + ETM_EXCEPTIONLEVEL0)
#define ETM_NONSECUREINSTRTRACINGSUPPORTED_EXCEPTIONLEVEL0_MASK    (0x1UL << REGISTER_FIELD_OFFSET(ETM, NONSECUREINSTRTRACINGSUPPORTED, EXCEPTIONLEVEL0))  /*!< Mask  0x00100000 */

// Values of bits of register controlling whether instruction tracing is supported for a given exception level in secure state
#define ETM_SECUREINSTRTRACINGSUPPORTED_EXCEPTIONLEVEL3_OFFSET  (REGISTER_FIELD_OFFSET(ETM, ACATR, EXLEVEL_S) + ETM_EXCEPTIONLEVEL3)
#define ETM_SECUREINSTRTRACINGSUPPORTED_EXCEPTIONLEVEL3_MASK    (0x1UL << REGISTER_FIELD_OFFSET(ETM, SECUREINSTRTRACINGSUPPORTED, EXCEPTIONLEVEL3))  /*!< Mask  0x00080000 */

#define ETM_SECUREINSTRTRACINGSUPPORTED_EXCEPTIONLEVEL2_OFFSET  (REGISTER_FIELD_OFFSET(ETM, ACATR, EXLEVEL_S) + ETM_EXCEPTIONLEVEL2)
#define ETM_SECUREINSTRTRACINGSUPPORTED_EXCEPTIONLEVEL2_MASK    (0x1UL << REGISTER_FIELD_OFFSET(ETM, SECUREINSTRTRACINGSUPPORTED, EXCEPTIONLEVEL2))  /*!< Mask  0x00040000 */

#define ETM_SECUREINSTRTRACINGSUPPORTED_EXCEPTIONLEVEL1_OFFSET  (REGISTER_FIELD_OFFSET(ETM, ACATR, EXLEVEL_S) + ETM_EXCEPTIONLEVEL1)
#define ETM_SECUREINSTRTRACINGSUPPORTED_EXCEPTIONLEVEL1_MASK    (0x1UL << REGISTER_FIELD_OFFSET(ETM, SECUREINSTRTRACINGSUPPORTED, EXCEPTIONLEVEL1))  /*!< Mask  0x00020000 */

#define ETM_SECUREINSTRTRACINGSUPPORTED_EXCEPTIONLEVEL0_OFFSET  (REGISTER_FIELD_OFFSET(ETM, ACATR, EXLEVEL_S) + ETM_EXCEPTIONLEVEL0)
#define ETM_SECUREINSTRTRACINGSUPPORTED_EXCEPTIONLEVEL0_MASK    (0x1UL << REGISTER_FIELD_OFFSET(ETM, SECUREINSTRTRACINGSUPPORTED, EXCEPTIONLEVEL0))  /*!< Mask  0x00010000 */
