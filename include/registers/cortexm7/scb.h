...
typedef struct {
	...
	RW uint32_t BFFAR;      /*!< Bus fault address register                        (Offset 0x38)         */
...
#define SCB_VTOR_TBLOFFSET_OFFSET  (7U)
#define SCB_VTOR_TBLOFFSET_MASK    (0x1FFFFFFUL << REGISTER_FIELD_OFFSET(SCB, VTOR, TBLOFFSET))      /*!< Mask  0xFFFFFF80 */

/*!< Application interrupt and reset control register */
#define SCB_AIRCR_VECTKEY_OFFSET                  (16U)
#define SCB_AIRCR_VECTKEY_MASK                    (0xFFFFUL << REGISTER_FIELD_OFFSET(SCB, AIRCR, VECTKEY))               /*!< Mask  0xFFFF0000 */
...
#define SCB_AIRCR_INTPRIORITYGROUP_OFFSET         (8U)
#define SCB_AIRCR_INTPRIORITYGROUP_MASK           (0x7UL << REGISTER_FIELD_OFFSET(SCB, AIRCR, INTPRIORITYGROUP))         /*!< Mask  0x00000700 */

#define SCB_AIRCR_EXTSRCSYSRSTREQ_OFFSET          (2U)
#define SCB_AIRCR_EXTSRCSYSRSTREQ_MASK            (0x1UL << REGISTER_FIELD_OFFSET(SCB, AIRCR, EXTSRCSYSRSTREQ))          /*!< Mask  0x00000004 */

#define SCB_AIRCR_ACTIVESTATEEXCEPTIONCLR_OFFSET  (1U)
#define SCB_AIRCR_ACTIVESTATEEXCEPTIONCLR_MASK    (0x1UL << REGISTER_FIELD_OFFSET(SCB, AIRCR, ACTIVESTATEEXCEPTIONCLR))  /*!< Mask  0x00000002 */

#define SCB_AIRCR_LOCALRST_OFFSET                 (0U)
#define SCB_AIRCR_LOCALRST_MASK                   (0x1UL << REGISTER_FIELD_OFFSET(SCB, AIRCR, LOCALRST))                 /*!< Mask  0x00000001 */
...
#define SCB_SCR_SENDEVENTONPENDING_OFFSET  (4U)
#define SCB_SCR_SENDEVENTONPENDING_MASK    (0x1UL << REGISTER_FIELD_OFFSET(SCB, SCR, SENDEVENTONPENDING))  /*!< Mask  0x00000010 */

#define SCB_SCR_SLEEPSTATE_OFFSET          (2U)
#define SCB_SCR_SLEEPSTATE_MASK            (0x1UL << REGISTER_FIELD_OFFSET(SCB, SCR, SLEEPSTATE))          /*!< Mask  0x00000004 */

#define SCB_SCR_SLEEPONISREXIT_OFFSET      (1U)
#define SCB_SCR_SLEEPONISREXIT_MASK        (0x1UL << REGISTER_FIELD_OFFSET(SCB, SCR, SLEEPONISREXIT))      /*!< Mask  0x00000002 */
...
#define SCB_CCR_BRANCHPRED_OFFSET                  (18U)
#define SCB_CCR_BRANCHPRED_MASK                    (0x1UL << REGISTER_FIELD_OFFSET(SCB, CCR, BRANCHPRED))                  /*!< Mask  0x00040000 */

#define SCB_CCR_ICACHE_OFFSET                      (17U)
#define SCB_CCR_ICACHE_MASK                        (0x1UL << REGISTER_FIELD_OFFSET(SCB, CCR, ICACHE))                      /*!< Mask  0x00020000 */

#define SCB_CCR_DCACHE_OFFSET                      (16U)
#define SCB_CCR_DCACHE_MASK                        (0x1UL << REGISTER_FIELD_OFFSET(SCB, CCR, DCACHE))                      /*!< Mask  0x00010000 */
...
#define SCB_CCR_DATAACCESSFAULTWITHPRIM1M2_OFFSET  (8U)
#define SCB_CCR_DATAACCESSFAULTWITHPRIM1M2_MASK    (0x1UL << REGISTER_FIELD_OFFSET(SCB, CCR, DATAACCESSFAULTWITHPRIM1M2))  /*!< Mask  0x00000100 */

#define SCB_CCR_DIV0TRAP_OFFSET                    (4U)
#define SCB_CCR_DIV0TRAP_MASK                      (0x1UL << REGISTER_FIELD_OFFSET(SCB, CCR, DIV0TRAP))                    /*!< Mask  0x00000010 */

#define SCB_CCR_UALIGNTRAP_OFFSET                  (3U)
#define SCB_CCR_UALIGNTRAP_MASK                    (0x1UL << REGISTER_FIELD_OFFSET(SCB, CCR, UNALIGNTRAP))                 /*!< Mask  0x00000008 */

#define SCB_CCR_UNPRIVILILEGEDSTIRACCESS_OFFSET    (1U)
#define SCB_CCR_UNPRIVILILEGEDSTIRACCESS_MASK      (0x1UL << REGISTER_FIELD_OFFSET(SCB, CCR, UNPRIVILILEGEDSTIRACCESS))    /*!< Mask  0x00000002 */

#define SCB_CCR_THREADMODEENTER_OFFSET             (0U)
#define SCB_CCR_THREADMODEENTER_MASK               (0x1UL << REGISTER_FIELD_OFFSET(SCB, CCR, THREADMODEENTER))             /*!< Mask  0x00000001 */
...
#define SCB_SHCSR_USAGEFAULTEN_OFFSET         (18U)
#define SCB_SHCSR_USAGEFAULTEN_MASK           (0x1UL << REGISTER_FIELD_OFFSET(SCB, SHCSR, USAGEFAULTEN))        /*!< Mask  0x00040000 */
...
#define SCB_SHCSR_MEMMANAGEEN_OFFSET          (16U)
#define SCB_SHCSR_MEMMANAGEEN_MASK            (0x1UL << REGISTER_FIELD_OFFSET(SCB, SHCSR, MEMMANAGEEN))         /*!< Mask  0x00010000 */

#define SCB_SHCSR_SVCALLPEND_OFFSET           (15U)
#define SCB_SHCSR_SVCALLPEND_MASK             (0x1UL << REGISTER_FIELD_OFFSET(SCB, SHCSR, SVCALLPEND))          /*!< Mask  0x00008000 */

#define SCB_SHCSR_BUSFAULTPEND_OFFSET         (14U)
#define SCB_SHCSR_BUSFAULTPEND_MASK           (0x1UL << REGISTER_FIELD_OFFSET(SCB, SHCSR, BUSFAULTPEND))        /*!< Mask  0x00004000 */

#define SCB_SHCSR_MEMMANAGEPEND_OFFSET        (13U)
#define SCB_SHCSR_MEMMANAGEPEND_MASK          (0x1UL << REGISTER_FIELD_OFFSET(SCB, SHCSR, MEMMANAGEPEND))       /*!< Mask  0x00002000 */

#define SCB_SHCSR_USAGEFAULTPEND_OFFSET       (12U)
#define SCB_SHCSR_USAGEFAULTPEND_MASK         (0x1UL << REGISTER_FIELD_OFFSET(SCB, SHCSR, USAGEFAULTPEND))      /*!< Mask  0x00001000 */

#define SCB_SHCSR_SYSTICKACTIVE_OFFSET        (11U)
#define SCB_SHCSR_SYSTICKACTIVE_MASK          (0x1UL << REGISTER_FIELD_OFFSET(SCB, SHCSR, SYSTICKACTIVE))       /*!< Mask  0x00000800 */

#define SCB_SHCSR_PENDSVACTIVE_OFFSET         (10U)
#define SCB_SHCSR_PENDSVACTIVE_MASK           (0x1UL << REGISTER_FIELD_OFFSET(SCB, SHCSR, PENDSVACTIVE))        /*!< Mask  0x00000400 */

#define SCB_SHCSR_DEBUGMONITORACTIVE_OFFSET   (8U)
#define SCB_SHCSR_DEBUGMONITORACTIVE_MASK     (0x1UL << REGISTER_FIELD_OFFSET(SCB, SHCSR, DEBUGMONITORACTIVE))  /*!< Mask  0x00000100 */

#define SCB_SHCSR_SVCALLACTIVE_OFFSET         (7U)
#define SCB_SHCSR_SVCALLACTIVE_MASK           (0x1UL << REGISTER_FIELD_OFFSET(SCB, SHCSR, SVCALLACTIVE))        /*!< Mask  0x00000080 */

#define SCB_SHCSR_USAGEFAULTACTIVE_OFFSET     (3U)
#define SCB_SHCSR_USAGEFAULTACTIVE_MASK       (0x1UL << REGISTER_FIELD_OFFSET(SCB, SHCSR, USAGEFAULTACTIVE))    /*!< Mask  0x00000008 */

#define SCB_SHCSR_BUSFAULTACTIVE_OFFSET       (1U)
#define SCB_SHCSR_BUSFAULTACTIVE_MASK         (0x1UL << REGISTER_FIELD_OFFSET(SCB, SHCSR, BUSFAULTACTIVE))      /*!< Mask  0x00000002 */

#define SCB_SHCSR_MEMMANAGEACTIVE_OFFSET      (0U)
#define SCB_SHCSR_MEMMANAGEACTIVE_MASK        (0x1UL << REGISTER_FIELD_OFFSET(SCB, SHCSR, MEMMANAGEACTIVE))     /*!< Mask  0x00000001 */
...
#define SCB_CFSR_USAGEFAULT_OFFSET  (16U)
#define SCB_CFSR_USAGEFAULT_MASK    (0xFFFFUL << REGISTER_FIELD_OFFSET(SCB, CFSR, USAGEFAULT))  /*!< Mask  0xFFFF0000 */

#define SCB_CFSR_BUSFAULT_OFFSET    (8U)
#define SCB_CFSR_BUSFAULT_MASK      (0xFFUL << REGISTER_FIELD_OFFSET(SCB, CFSR, BUSFAULT))      /*!< Mask  0x0000FF00 */

#define SCB_CFSR_MEMMANAGE_OFFSET   (0U)
#define SCB_CFSR_MEMMANAGE_MASK     (0xFFUL << REGISTER_FIELD_OFFSET(SCB, CFSR, MEMMANAGE))     /*!< Mask  0x000000FF */

// Values of UsageFault status register
#define SCB_USAGEFAULTSTATUS_DIVBYZERO_OFFSET          (REGISTER_FIELD_OFFSET(SCB, CFSR, USAGEFAULT) + 9U)
#define SCB_USAGEFAULTSTATUS_DIVBYZERO_MASK            (0x1UL << REGISTER_FIELD_OFFSET(SCB, USAGEFAULTSTATUS, DIVBYZERO))          /*!< Mask  0x02000000 */

#define SCB_USAGEFAULTSTATUS_UNALIGNEDACCESS_OFFSET    (REGISTER_FIELD_OFFSET(SCB, CFSR, USAGEFAULT) + 8U)
...
#define SCB_USAGEFAULTSTATUS_COPROCESSORACCESS_OFFSET  (REGISTER_FIELD_OFFSET(SCB, CFSR, USAGEFAULT) + 3U)
...
#define SCB_USAGEFAULTSTATUS_INVALIDPCLOAD_OFFSET      (REGISTER_FIELD_OFFSET(SCB, CFSR, USAGEFAULT) + 2U)
...
#define SCB_USAGEFAULTSTATUS_INVALIDSTATE_OFFSET       (REGISTER_FIELD_OFFSET(SCB, CFSR, USAGEFAULT) + 1U)
...
#define SCB_USAGEFAULTSTATUS_UNDEFINEDINSTR_OFFSET     (REGISTER_FIELD_OFFSET(SCB, CFSR, USAGEFAULT) + 0U)
...
#define SCB_BUSFAULTSTATUS_VALID_OFFSET                    (REGISTER_FIELD_OFFSET(SCB, CFSR, BUSFAULT) + 7U)
#define SCB_BUSFAULTSTATUS_VALID_MASK                      (0x1UL << REGISTER_FIELD_OFFSET(SCB, BUSFAULTSTATUS, VALID))                    /*!< Mask  0x00008000 */

#define SCB_BUSFAULTSTATUS_FPLAZYSTATEPRESERVATION_OFFSET  (REGISTER_FIELD_OFFSET(SCB, CFSR, BUSFAULT) + 5U)
...
#define SCB_BUSFAULTSTATUS_EXCEPTIONENTRY_OFFSET           (REGISTER_FIELD_OFFSET(SCB, CFSR, BUSFAULT) + 4U)
...
#define SCB_BUSFAULTSTATUS_EXCEPTIONRETURN_OFFSET          (REGISTER_FIELD_OFFSET(SCB, CFSR, BUSFAULT) + 3U)
...
#define SCB_BUSFAULTSTATUS_IMPRECISEDATABUSERROR_OFFSET    (REGISTER_FIELD_OFFSET(SCB, CFSR, BUSFAULT) + 2U)
...
#define SCB_BUSFAULTSTATUS_DATABUSERROR_OFFSET             (REGISTER_FIELD_OFFSET(SCB, CFSR, BUSFAULT) + 1U)
#define SCB_BUSFAULTSTATUS_DATABUSERROR_MASK               (0x1UL << REGISTER_FIELD_OFFSET(SCB, BUSFAULTSTATUS, DATABUSERROR))             /*!< Mask  0x00000200 */

#define SCB_BUSFAULTSTATUS_INSTRBUSERROR_OFFSET            (REGISTER_FIELD_OFFSET(SCB, CFSR, BUSFAULT) + 0U)
...
#define SCB_MEMMANAGEFAULTSTATUS_VALID_OFFSET                    (REGISTER_FIELD_OFFSET(SCB, CFSR, MEMMANAGE) + 7U)
#define SCB_MEMMANAGEFAULTSTATUS_VALID_MASK                      (0x1UL << REGISTER_FIELD_OFFSET(SCB, MEMMANAGEFAULTSTATUS, VALID))                    /*!< Mask  0x00000080 */

#define SCB_MEMMANAGEFAULTSTATUS_FPLAZYSTATEPRESERVATION_OFFSET  (REGISTER_FIELD_OFFSET(SCB, CFSR, MEMMANAGE) + 5U)
...
#define SCB_MEMMANAGEFAULTSTATUS_EXCEPTIONENTRY_OFFSET           (REGISTER_FIELD_OFFSET(SCB, CFSR, MEMMANAGE) + 4U)
...
#define SCB_MEMMANAGEFAULTSTATUS_EXCEPTIONRETURN_OFFSET          (REGISTER_FIELD_OFFSET(SCB, CFSR, MEMMANAGE) + 3U)
...
#define SCB_MEMMANAGEFAULTSTATUS_DATAACCESSVIOLATION_OFFSET      (REGISTER_FIELD_OFFSET(SCB, CFSR, MEMMANAGE) + 1U)
...
#define SCB_MEMMANAGEFAULTSTATUS_INSTRACCESSVIOLATION_OFFSET     (REGISTER_FIELD_OFFSET(SCB, CFSR, MEMMANAGE) + 0U)
...
#define SCB_HFSR_DEBUGEVENT_OFFSET      (31U)
#define SCB_HFSR_DEBUGEVENT_MASK        (0x1UL << REGISTER_FIELD_OFFSET(SCB, HFSR, DEBUGEVENT))      /*!< Mask  0x80000000 */

#define SCB_HFSR_FAULTESCALATED_OFFSET  (30U)
#define SCB_HFSR_FAULTESCALATED_MASK    (0x1UL << REGISTER_FIELD_OFFSET(SCB, HFSR, FAULTESCALATED))  /*!< Mask  0x40000000 */

#define SCB_HFSR_VECTTBLREAD_OFFSET     (1U)
#define SCB_HFSR_VECTTBLREAD_MASK       (0x1UL << REGISTER_FIELD_OFFSET(SCB, HFSR, VECTTBLREAD))     /*!< Mask  0x00000002 */
...
#define SCB_DFSR_EXTERNALREQ_OFFSET  (4U)
#define SCB_DFSR_EXTERNALREQ_MASK    (0x1UL << REGISTER_FIELD_OFFSET(SCB, DFSR, EXTERNALREQ))  /*!< Mask  0x00000010 */

#define SCB_DFSR_VECTCATCH_OFFSET    (3U)
#define SCB_DFSR_VECTCATCH_MASK      (0x1UL << REGISTER_FIELD_OFFSET(SCB, DFSR, VECTCATCH))    /*!< Mask  0x00000008 */
...
#define SCB_DFSR_BREAKPOINT_OFFSET   (1U)
#define SCB_DFSR_BREAKPOINT_MASK     (0x1UL << REGISTER_FIELD_OFFSET(SCB, DFSR, BREAKPOINT))   /*!< Mask  0x00000002 */

#define SCB_DFSR_HALTREQ_OFFSET      (0U)
#define SCB_DFSR_HALTREQ_MASK        (0x1UL << REGISTER_FIELD_OFFSET(SCB, DFSR, HALTREQ))      /*!< Mask  0x00000001 */
...
#define SCB_BFFAR_ADDRESS_OFFSET  (0U)
#define SCB_BFFAR_ADDRESS_MASK    (0xFFFFFFFFUL << REGISTER_FIELD_OFFSET(SCB, BFFAR, ADDRESS))  /*!< Mask  0xFFFFFFFF */
#define SCB_BFFAR_ADDRESS_0       (0x00000001UL << REGISTER_FIELD_OFFSET(SCB, BFFAR, ADDRESS))  /*!< Value 0x00000001 */
#define SCB_BFFAR_ADDRESS_1       (0x00000002UL << REGISTER_FIELD_OFFSET(SCB, BFFAR, ADDRESS))  /*!< Value 0x00000002 */
#define SCB_BFFAR_ADDRESS_2       (0x00000004UL << REGISTER_FIELD_OFFSET(SCB, BFFAR, ADDRESS))  /*!< Value 0x00000004 */
#define SCB_BFFAR_ADDRESS_3       (0x00000008UL << REGISTER_FIELD_OFFSET(SCB, BFFAR, ADDRESS))  /*!< Value 0x00000008 */
#define SCB_BFFAR_ADDRESS_4       (0x00000010UL << REGISTER_FIELD_OFFSET(SCB, BFFAR, ADDRESS))  /*!< Value 0x00000010 */
#define SCB_BFFAR_ADDRESS_5       (0x00000020UL << REGISTER_FIELD_OFFSET(SCB, BFFAR, ADDRESS))  /*!< Value 0x00000020 */
#define SCB_BFFAR_ADDRESS_6       (0x00000040UL << REGISTER_FIELD_OFFSET(SCB, BFFAR, ADDRESS))  /*!< Value 0x00000040 */
#define SCB_BFFAR_ADDRESS_7       (0x00000080UL << REGISTER_FIELD_OFFSET(SCB, BFFAR, ADDRESS))  /*!< Value 0x00000080 */
#define SCB_BFFAR_ADDRESS_8       (0x00000100UL << REGISTER_FIELD_OFFSET(SCB, BFFAR, ADDRESS))  /*!< Value 0x00000100 */
#define SCB_BFFAR_ADDRESS_9       (0x00000200UL << REGISTER_FIELD_OFFSET(SCB, BFFAR, ADDRESS))  /*!< Value 0x00000200 */
#define SCB_BFFAR_ADDRESS_10      (0x00000400UL << REGISTER_FIELD_OFFSET(SCB, BFFAR, ADDRESS))  /*!< Value 0x00000400 */
#define SCB_BFFAR_ADDRESS_11      (0x00000800UL << REGISTER_FIELD_OFFSET(SCB, BFFAR, ADDRESS))  /*!< Value 0x00000800 */
#define SCB_BFFAR_ADDRESS_12      (0x00001000UL << REGISTER_FIELD_OFFSET(SCB, BFFAR, ADDRESS))  /*!< Value 0x00001000 */
#define SCB_BFFAR_ADDRESS_13      (0x00002000UL << REGISTER_FIELD_OFFSET(SCB, BFFAR, ADDRESS))  /*!< Value 0x00002000 */
#define SCB_BFFAR_ADDRESS_14      (0x00004000UL << REGISTER_FIELD_OFFSET(SCB, BFFAR, ADDRESS))  /*!< Value 0x00004000 */
#define SCB_BFFAR_ADDRESS_15      (0x00008000UL << REGISTER_FIELD_OFFSET(SCB, BFFAR, ADDRESS))  /*!< Value 0x00008000 */
#define SCB_BFFAR_ADDRESS_16      (0x00010000UL << REGISTER_FIELD_OFFSET(SCB, BFFAR, ADDRESS))  /*!< Value 0x00010000 */
#define SCB_BFFAR_ADDRESS_17      (0x00020000UL << REGISTER_FIELD_OFFSET(SCB, BFFAR, ADDRESS))  /*!< Value 0x00020000 */
#define SCB_BFFAR_ADDRESS_18      (0x00040000UL << REGISTER_FIELD_OFFSET(SCB, BFFAR, ADDRESS))  /*!< Value 0x00040000 */
#define SCB_BFFAR_ADDRESS_19      (0x00080000UL << REGISTER_FIELD_OFFSET(SCB, BFFAR, ADDRESS))  /*!< Value 0x00080000 */
#define SCB_BFFAR_ADDRESS_20      (0x00100000UL << REGISTER_FIELD_OFFSET(SCB, BFFAR, ADDRESS))  /*!< Value 0x00100000 */
#define SCB_BFFAR_ADDRESS_21      (0x00200000UL << REGISTER_FIELD_OFFSET(SCB, BFFAR, ADDRESS))  /*!< Value 0x00200000 */
#define SCB_BFFAR_ADDRESS_22      (0x00400000UL << REGISTER_FIELD_OFFSET(SCB, BFFAR, ADDRESS))  /*!< Value 0x00400000 */
#define SCB_BFFAR_ADDRESS_23      (0x00800000UL << REGISTER_FIELD_OFFSET(SCB, BFFAR, ADDRESS))  /*!< Value 0x00800000 */
#define SCB_BFFAR_ADDRESS_24      (0x01000000UL << REGISTER_FIELD_OFFSET(SCB, BFFAR, ADDRESS))  /*!< Value 0x01000000 */
#define SCB_BFFAR_ADDRESS_25      (0x02000000UL << REGISTER_FIELD_OFFSET(SCB, BFFAR, ADDRESS))  /*!< Value 0x02000000 */
#define SCB_BFFAR_ADDRESS_26      (0x04000000UL << REGISTER_FIELD_OFFSET(SCB, BFFAR, ADDRESS))  /*!< Value 0x04000000 */
#define SCB_BFFAR_ADDRESS_27      (0x08000000UL << REGISTER_FIELD_OFFSET(SCB, BFFAR, ADDRESS))  /*!< Value 0x08000000 */
#define SCB_BFFAR_ADDRESS_28      (0x10000000UL << REGISTER_FIELD_OFFSET(SCB, BFFAR, ADDRESS))  /*!< Value 0x10000000 */
#define SCB_BFFAR_ADDRESS_29      (0x20000000UL << REGISTER_FIELD_OFFSET(SCB, BFFAR, ADDRESS))  /*!< Value 0x20000000 */
#define SCB_BFFAR_ADDRESS_30      (0x40000000UL << REGISTER_FIELD_OFFSET(SCB, BFFAR, ADDRESS))  /*!< Value 0x40000000 */
#define SCB_BFFAR_ADDRESS_31      (0x80000000UL << REGISTER_FIELD_OFFSET(SCB, BFFAR, ADDRESS))  /*!< Value 0x80000000 */
...
#define SCB_CPACR_ACCESSPRIVILEGES11_OFFSET  (22U)
#define SCB_CPACR_ACCESSPRIVILEGES11_MASK    (0x3UL << REGISTER_FIELD_OFFSET(SCB, CPACR, ACCESSPRIVILEGES11))  /*!< Mask  0x00C00000 */
#define SCB_CPACR_ACCESSPRIVILEGES11_0       (0x1UL << REGISTER_FIELD_OFFSET(SCB, CPACR, ACCESSPRIVILEGES11))  /*!< Value 0x00400000 */
#define SCB_CPACR_ACCESSPRIVILEGES11_1       (0x2UL << REGISTER_FIELD_OFFSET(SCB, CPACR, ACCESSPRIVILEGES11))  /*!< Value 0x00800000 */

#define SCB_CPACR_ACCESSPRIVILEGES10_OFFSET  (20U)
#define SCB_CPACR_ACCESSPRIVILEGES10_MASK    (0x3UL << REGISTER_FIELD_OFFSET(SCB, CPACR, ACCESSPRIVILEGES10))  /*!< Mask  0x00300000 */
#define SCB_CPACR_ACCESSPRIVILEGES10_0       (0x1UL << REGISTER_FIELD_OFFSET(SCB, CPACR, ACCESSPRIVILEGES10))  /*!< Value 0x00100000 */
#define SCB_CPACR_ACCESSPRIVILEGES10_1       (0x2UL << REGISTER_FIELD_OFFSET(SCB, CPACR, ACCESSPRIVILEGES10))  /*!< Value 0x00200000 */

#define SCB_CPACR_ACCESSPRIVILEGES7_OFFSET   (14U)
#define SCB_CPACR_ACCESSPRIVILEGES7_MASK     (0x3UL << REGISTER_FIELD_OFFSET(SCB, CPACR, ACCESSPRIVILEGES7))   /*!< Mask  0x0000C000 */
#define SCB_CPACR_ACCESSPRIVILEGES7_0        (0x1UL << REGISTER_FIELD_OFFSET(SCB, CPACR, ACCESSPRIVILEGES7))   /*!< Value 0x00004000 */
#define SCB_CPACR_ACCESSPRIVILEGES7_1        (0x2UL << REGISTER_FIELD_OFFSET(SCB, CPACR, ACCESSPRIVILEGES7))   /*!< Value 0x00008000 */

#define SCB_CPACR_ACCESSPRIVILEGES6_OFFSET   (12U)
#define SCB_CPACR_ACCESSPRIVILEGES6_MASK     (0x3UL << REGISTER_FIELD_OFFSET(SCB, CPACR, ACCESSPRIVILEGES6))   /*!< Mask  0x00003000 */
#define SCB_CPACR_ACCESSPRIVILEGES6_0        (0x1UL << REGISTER_FIELD_OFFSET(SCB, CPACR, ACCESSPRIVILEGES6))   /*!< Value 0x00001000 */
#define SCB_CPACR_ACCESSPRIVILEGES6_1        (0x2UL << REGISTER_FIELD_OFFSET(SCB, CPACR, ACCESSPRIVILEGES6))   /*!< Value 0x00002000 */

#define SCB_CPACR_ACCESSPRIVILEGES5_OFFSET   (10U)
#define SCB_CPACR_ACCESSPRIVILEGES5_MASK     (0x3UL << REGISTER_FIELD_OFFSET(SCB, CPACR, ACCESSPRIVILEGES5))   /*!< Mask  0x00000C00 */
#define SCB_CPACR_ACCESSPRIVILEGES5_0        (0x1UL << REGISTER_FIELD_OFFSET(SCB, CPACR, ACCESSPRIVILEGES5))   /*!< Value 0x00000400 */
#define SCB_CPACR_ACCESSPRIVILEGES5_1        (0x2UL << REGISTER_FIELD_OFFSET(SCB, CPACR, ACCESSPRIVILEGES5))   /*!< Value 0x00000800 */

#define SCB_CPACR_ACCESSPRIVILEGES4_OFFSET   (8U)
#define SCB_CPACR_ACCESSPRIVILEGES4_MASK     (0x3UL << REGISTER_FIELD_OFFSET(SCB, CPACR, ACCESSPRIVILEGES4))   /*!< Mask  0x00000300 */
#define SCB_CPACR_ACCESSPRIVILEGES4_0        (0x1UL << REGISTER_FIELD_OFFSET(SCB, CPACR, ACCESSPRIVILEGES4))   /*!< Value 0x00000100 */
#define SCB_CPACR_ACCESSPRIVILEGES4_1        (0x2UL << REGISTER_FIELD_OFFSET(SCB, CPACR, ACCESSPRIVILEGES4))   /*!< Value 0x00000200 */

#define SCB_CPACR_ACCESSPRIVILEGES3_OFFSET   (6U)
#define SCB_CPACR_ACCESSPRIVILEGES3_MASK     (0x3UL << REGISTER_FIELD_OFFSET(SCB, CPACR, ACCESSPRIVILEGES3))   /*!< Mask  0x000000C0 */
#define SCB_CPACR_ACCESSPRIVILEGES3_0        (0x1UL << REGISTER_FIELD_OFFSET(SCB, CPACR, ACCESSPRIVILEGES3))   /*!< Value 0x00000040 */
#define SCB_CPACR_ACCESSPRIVILEGES3_1        (0x2UL << REGISTER_FIELD_OFFSET(SCB, CPACR, ACCESSPRIVILEGES3))   /*!< Value 0x00000080 */

#define SCB_CPACR_ACCESSPRIVILEGES2_OFFSET   (4U)
#define SCB_CPACR_ACCESSPRIVILEGES2_MASK     (0x3UL << REGISTER_FIELD_OFFSET(SCB, CPACR, ACCESSPRIVILEGES2))   /*!< Mask  0x00000030 */
#define SCB_CPACR_ACCESSPRIVILEGES2_0        (0x1UL << REGISTER_FIELD_OFFSET(SCB, CPACR, ACCESSPRIVILEGES2))   /*!< Value 0x00000010 */
#define SCB_CPACR_ACCESSPRIVILEGES2_1        (0x2UL << REGISTER_FIELD_OFFSET(SCB, CPACR, ACCESSPRIVILEGES2))   /*!< Value 0x00000020 */

#define SCB_CPACR_ACCESSPRIVILEGES1_OFFSET   (2U)
#define SCB_CPACR_ACCESSPRIVILEGES1_MASK     (0x3UL << REGISTER_FIELD_OFFSET(SCB, CPACR, ACCESSPRIVILEGES1))   /*!< Mask  0x0000000C */
#define SCB_CPACR_ACCESSPRIVILEGES1_0        (0x1UL << REGISTER_FIELD_OFFSET(SCB, CPACR, ACCESSPRIVILEGES1))   /*!< Value 0x00000004 */
#define SCB_CPACR_ACCESSPRIVILEGES1_1        (0x2UL << REGISTER_FIELD_OFFSET(SCB, CPACR, ACCESSPRIVILEGES1))   /*!< Value 0x00000008 */

#define SCB_CPACR_ACCESSPRIVILEGES0_OFFSET   (0U)
#define SCB_CPACR_ACCESSPRIVILEGES0_MASK     (0x3UL << REGISTER_FIELD_OFFSET(SCB, CPACR, ACCESSPRIVILEGES0))   /*!< Mask  0x00000003 */
#define SCB_CPACR_ACCESSPRIVILEGES0_0        (0x1UL << REGISTER_FIELD_OFFSET(SCB, CPACR, ACCESSPRIVILEGES0))   /*!< Value 0x00000001 */
#define SCB_CPACR_ACCESSPRIVILEGES0_1        (0x2UL << REGISTER_FIELD_OFFSET(SCB, CPACR, ACCESSPRIVILEGES0))   /*!< Value 0x00000002 */
