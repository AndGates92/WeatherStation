...
typedef struct {
	...
	RO uint32_t CALIB;           /*!< Calibration value register   (Offset 0xC)          */
	   uint32_t reserved1[60U];  /*!< Reserved                     (Offset 0x10 to 0xFC) */
} systick_regs;
...
#define SYSTICK_CALIB_RELOAD_OFFSET  (0U)
#define SYSTICK_CALIB_RELOAD_MASK    (0xFFFFFFUL << REGISTER_FIELD_OFFSET(SYSTICK, CALIB, RELOAD))  /*!< Mask  0x00FFFFFF */
#define SYSTICK_CALIB_RELOAD_0       (0x000001UL << REGISTER_FIELD_OFFSET(SYSTICK, CALIB, RELOAD))  /*!< Value 0x00000001 */
#define SYSTICK_CALIB_RELOAD_1       (0x000002UL << REGISTER_FIELD_OFFSET(SYSTICK, CALIB, RELOAD))  /*!< Value 0x00000002 */
#define SYSTICK_CALIB_RELOAD_2       (0x000004UL << REGISTER_FIELD_OFFSET(SYSTICK, CALIB, RELOAD))  /*!< Value 0x00000004 */
#define SYSTICK_CALIB_RELOAD_3       (0x000008UL << REGISTER_FIELD_OFFSET(SYSTICK, CALIB, RELOAD))  /*!< Value 0x00000008 */
#define SYSTICK_CALIB_RELOAD_4       (0x000010UL << REGISTER_FIELD_OFFSET(SYSTICK, CALIB, RELOAD))  /*!< Value 0x00000010 */
#define SYSTICK_CALIB_RELOAD_5       (0x000020UL << REGISTER_FIELD_OFFSET(SYSTICK, CALIB, RELOAD))  /*!< Value 0x00000020 */
#define SYSTICK_CALIB_RELOAD_6       (0x000040UL << REGISTER_FIELD_OFFSET(SYSTICK, CALIB, RELOAD))  /*!< Value 0x00000040 */
#define SYSTICK_CALIB_RELOAD_7       (0x000080UL << REGISTER_FIELD_OFFSET(SYSTICK, CALIB, RELOAD))  /*!< Value 0x00000080 */
#define SYSTICK_CALIB_RELOAD_8       (0x000100UL << REGISTER_FIELD_OFFSET(SYSTICK, CALIB, RELOAD))  /*!< Value 0x00000100 */
#define SYSTICK_CALIB_RELOAD_9       (0x000200UL << REGISTER_FIELD_OFFSET(SYSTICK, CALIB, RELOAD))  /*!< Value 0x00000200 */
#define SYSTICK_CALIB_RELOAD_10      (0x000400UL << REGISTER_FIELD_OFFSET(SYSTICK, CALIB, RELOAD))  /*!< Value 0x00000400 */
#define SYSTICK_CALIB_RELOAD_11      (0x000800UL << REGISTER_FIELD_OFFSET(SYSTICK, CALIB, RELOAD))  /*!< Value 0x00000800 */
#define SYSTICK_CALIB_RELOAD_12      (0x001000UL << REGISTER_FIELD_OFFSET(SYSTICK, CALIB, RELOAD))  /*!< Value 0x00001000 */
#define SYSTICK_CALIB_RELOAD_13      (0x002000UL << REGISTER_FIELD_OFFSET(SYSTICK, CALIB, RELOAD))  /*!< Value 0x00002000 */
#define SYSTICK_CALIB_RELOAD_14      (0x004000UL << REGISTER_FIELD_OFFSET(SYSTICK, CALIB, RELOAD))  /*!< Value 0x00004000 */
#define SYSTICK_CALIB_RELOAD_15      (0x008000UL << REGISTER_FIELD_OFFSET(SYSTICK, CALIB, RELOAD))  /*!< Value 0x00008000 */
#define SYSTICK_CALIB_RELOAD_16      (0x010000UL << REGISTER_FIELD_OFFSET(SYSTICK, CALIB, RELOAD))  /*!< Value 0x00010000 */
#define SYSTICK_CALIB_RELOAD_17      (0x020000UL << REGISTER_FIELD_OFFSET(SYSTICK, CALIB, RELOAD))  /*!< Value 0x00020000 */
#define SYSTICK_CALIB_RELOAD_18      (0x040000UL << REGISTER_FIELD_OFFSET(SYSTICK, CALIB, RELOAD))  /*!< Value 0x00040000 */
#define SYSTICK_CALIB_RELOAD_19      (0x080000UL << REGISTER_FIELD_OFFSET(SYSTICK, CALIB, RELOAD))  /*!< Value 0x00080000 */
#define SYSTICK_CALIB_RELOAD_20      (0x100000UL << REGISTER_FIELD_OFFSET(SYSTICK, CALIB, RELOAD))  /*!< Value 0x00100000 */
#define SYSTICK_CALIB_RELOAD_21      (0x200000UL << REGISTER_FIELD_OFFSET(SYSTICK, CALIB, RELOAD))  /*!< Value 0x00200000 */
#define SYSTICK_CALIB_RELOAD_22      (0x400000UL << REGISTER_FIELD_OFFSET(SYSTICK, CALIB, RELOAD))  /*!< Value 0x00400000 */
#define SYSTICK_CALIB_RELOAD_23      (0x800000UL << REGISTER_FIELD_OFFSET(SYSTICK, CALIB, RELOAD))  /*!< Value 0x00800000 */
